  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-lg max-w-none space-y-8">
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4">第1条（個人情報取扱事業者の名称および連絡先）</h2>
          <p className="mb-4">
            個人情報保護法第32条第1項の規定に基づき、個人情報取扱事業者の情報を以下の通り公表します。
          </p>
            ...
            <table className="w-full">
              <tbody>
                <tr className="border-b">
                  <td className="py-2 font-semibold w-1/3">事業者の氏名</td>
                  <td className="py-2">中根大輔</td>
                </tr>
                <tr className="border-b">
                  <td className="py-2 font-semibold">所在地</td>
                  <td className="py-2">
                    〒590-0004 大阪府堺市堺区北清水町3-5-18
                  </td>
                </tr>
                <tr>
                  <td className="py-2 font-semibold">連絡先</td>
                  <td className="py-2">
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4">第2条（取得する個人情報の項目）</h2>
          <p className="mb-4">
            当方は、本サービスの提供にあたり、以下の個人情報を取得します。
          </p>

          <h3 className="text-xl font-semibold mb-3">2.1 ユーザーから直接取得する情報</h3>
          ...
          <h3 className="text-xl font-semibold mb-3">2.2 自動的に取得される情報</h3>
          <ul className="list-disc pl-6 space-y-2 mb-4">
          ...
          <h3 className="text-xl font-semibold mb-3">2.3 外部サービスとの連携により取得する情報</h3>
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4">第3条（個人情報の取得方法）</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4">第4条（利用目的）</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4">第5条（個人データの保管場所および管理方法）</h2>
          <p className="mb-4">
            ユーザーの個人データは、<strong>Supabase, Inc.（米国）</strong>が提供するデータベースおよびストレージサービスに保管されます。
          </p>
          <p className="mb-4">
            Supabaseは、ISO 27001認証を取得しており、業界標準のセキュリティ対策（データの暗号化、アクセス制御、監査ログ）を実施しています。
          </p>
          <p>
            当方は、Supabaseとの間で適切なデータ処理契約を締結し、個人データの安全管理について合意しています。
          </p>
        </section>
        ...
        <section>
          ...
          <h3 className="text-xl font-semibold mb-3">6.2 人的安全管理措置</h3>
          <ul className="list-disc pl-6 space-y-2 mb-4">
            <li>個人データの適正な取扱いに関する定期的な自己研修の実施</li>
            <li>外部委託先との間で機密保持契約（NDA）を締結</li>
          </ul>

          <h3 className="text-xl font-semibold mb-3">6.3 物理的安全管理措置</h3>
          <ul className="list-disc pl-6 space-y-2 mb-4">
            <li>個人データを取り扱う機器への物理的なアクセス制限</li>
            <li>個人データを含む記録媒体（PCハードディスク等）の厳重な保管および廃棄時の完全消去</li>
          </ul>

          <h3 className="text-xl font-semibold mb-3">6.4 技術的安全管理措置</h3>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4">第7条（第三者提供）</h2>
          <p className="mb-4">
          ...
          <h3 className="text-xl font-semibold mb-3">7.1 第三者への委託</h3>
          <p className="mb-4">
            当方は、本サービスの運営上、以下の第三者サービスに個人データの取扱いを委託しています。
            委託先に対しては、適切な監督を行い、個人データの安全管理が図られるよう必要な措置を講じています。
          </p>
          <div className="bg-gray-50 p-4 rounded mb-4">
            <p className="font-semibold mb-2">委託先一覧：</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>
              ...
              <li>
                ...
                <a href="https://expo.dev/privacy" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline text-sm">
                  Expo Privacy Policy
                </a>
              </li>
              <li>
                ...
                <a href="https://www.apple.com/legal/privacy/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline text-sm">
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4">第8条（個人データの開示、訂正、利用停止等の請求）</h2>
          <p className="mb-4">
            ユーザーは、当方に対し、個人情報保護法の定めに基づき、以下の権利を行使することができます。
          </p>

          <h3 className="text-xl font-semibold mb-3">8.1 開示請求</h3>
          <p className="mb-4">
            ユーザーは、当方が保有するご自身の個人データの開示を請求することができます（法第33条）。
          </p>

          <h3 className="text-xl font-semibold mb-3">8.2 訂正・追加・削除請求</h3>
          <p className="mb-4">
            ユーザーは、ご自身の個人データの内容が事実でないと判断した場合、
            訂正、追加または削除（以下「訂正等」）を請求することができます（法第34条）。
          </p>

          <h3 className="text-xl font-semibold mb-3">8.3 利用停止・消去請求</h3>
          <p className="mb-4">
            ユーザーは、以下のいずれかに該当する場合、個人データの利用停止または消去を請求することができます（法第35条）。
          </p>
          <ul className="list-disc pl-6 space-y-2 mb-4">
          ...
          <h3 className="text-xl font-semibold mb-3">8.4 請求手続き</h3>
          <p className="mb-4">上記の請求を行う場合は、以下の連絡先までメールにてご連絡ください。</p>
          <div className="bg-gray-50 p-4 rounded mb-4">
            <p className="font-semibold">請求受付窓口：</p>
            <p>
              メールアドレス：
              <a href="mailto:support@standmate.app" className="text-blue-600 hover:underline">
                support@standmate.app
          ...
          <p className="mb-4">
            当方は、ご本人確認を行った上で、遅滞なく（原則として2週間以内に）対応いたします。
          </p>
        </section>

        <section>
          <h2 className="text-2xl font-bold mb-4">第9条（アカウントの削除および個人データの消去）</h2>
          <p className="mb-4">
          ...
          <p className="mb-4">
            アカウント削除後、個人データは原則として速やかに（30日以内に）削除されます。
            ただし、以下の情報については、法令で保管が義務付けられている期間、または紛争解決のために必要な期間、保管することがあります。
          </p>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4">第10条（苦情の申出先）</h2>
          <p className="mb-4">
            個人情報の取扱いに関する苦情については、以下の窓口までご連絡ください。
          </p>
          <div className="bg-gray-50 p-4 rounded">
            <p className="font-semibold">苦情申出窓口：</p>
            <p>
              メールアドレス：
              <a href="mailto:support@standmate.app" className="text-blue-600 hover:underline">
                support@standmate.app
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4">第11条（未成年者の利用）</h2>
          <p>
            本サービスは18歳以上の方を対象としています。<br />
            18歳未満の方が本サービスを利用する場合は、保護者の同意が必要です。
          </p>
        </section>

        <section>
          <h2 className="text-2xl font-bold mb-4">第12条（プライバシーポリシーの変更）</h2>
          <p className="mb-4">
